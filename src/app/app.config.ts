...
export const appConfig: ApplicationConfig = {
  providers: [provideRouter(routes, withViewTransitions()),provideAnimations(), DatePipe, importProvidersFrom(AngularFireModule.initializeApp({
  ...
  })), RecaptchaModule, provideFirebaseApp(() => initializeApp({
    apiKey: "AIzaSyA_4Ej40-VVj8UQRH5rYKqYAdRIXxtgtH4",
    authDomain: "tpfinal-54230.firebaseapp.com",
    projectId: "tpfinal-54230",
    storageBucket: "tpfinal-54230.appspot.com",
